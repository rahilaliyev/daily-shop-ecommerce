...
import { electronicsCategory, addToBasket } from "../../redux/actions/actions";
...
const Mens = () => {
  ...
  const electronicsCategories = useSelector(
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => dispatch(electronicsCategory(res.data)))
  ...
  return (
    <div className="category">
      <div className="product-container container">
        {electronicsCategories.map((item, key) => (
