...
import { womensCategory, addToBasket } from "../../redux/actions/actions";
...
const Mens = () => {
  ...
  const womensCategories = useSelector(
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => dispatch(womensCategory(res.data)))
