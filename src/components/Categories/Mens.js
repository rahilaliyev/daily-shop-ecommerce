...
import { mensCategory, addToBasket } from "../../redux/actions/actions";
...
const Mens = () => {
  ...
  const mensCategories = useSelector((state) => state.categoriesReduceer.data);
  const isLogged = useSelector((state) => state.login.data);
  useEffect(() => {
    axios
      .get("https://fakestoreapi.com/products/category/men's clothing")
      .then((res) => dispatch(mensCategory(res.data)))
